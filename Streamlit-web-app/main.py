...
def main():
    ...
    with tab1:
        ...
        st.subheader('Key Features of the Application:', divider='blue')
        st.markdown("""
                    1. Detection of football players, referees, and the ball.
                    2. Prediction of players' teams.
                    3. Estimation of player and ball positions on a tactical map.
                    4. Ball tracking functionality.
                    """)
        st.subheader('Getting Started:', divider='blue')
        st.markdown("""
                    **Upon launching the app, two demo videos will automatically load, along with the recommended settings and hyperparameters.**
                    1. Use the sidebar menu's "Browse files" button to upload a video for analysis.
                    2. Enter the corresponding team names for the uploaded video in the sidebar text fields.
                    3. Navigate to the "Team Colors" tab on the main page.
                    4. Choose a frame that clearly displays the players and goalkeepers from both teams.
                    5. Follow the instructions provided on the page to select the colors for each team.
                    6. Go to the "Model Hyperparameters & Detection" tab, adjust the hyperparameters, and select annotation options (default settings are recommended).
                    7. Initiate the Detection process!
                    8. If the "save outputs" option is selected, the saved video will be located in the "outputs" directory.
                    """)
